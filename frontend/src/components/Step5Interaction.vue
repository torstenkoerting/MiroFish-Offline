            ...
            <div v-if="showToolsDetail" class="tools-card-body">
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('step5.toolPanoramaTitle') }}</div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">{{ $t('step5.toolQuickQueryDesc') }}</div>
                  </div>
                </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">{{ $t('step5.introduction') }}</div>
...
.action-bar {
  ...
  background: linear-gradient(180deg, var(--bg-2) 0%, #FAFBFC 100%);
  gap: 16px;
}
...
.tools-card-avatar {
  ...
  min-width: 44px;
  min-height: 44px;
  background: linear-gradient(135deg, var(--text-200) 0%, var(--text-200) 100%);
  color: var(--text-100);
  border-radius: 50%;
  display: flex;
  align-items: center;
...
.dropdown-item:hover {
  background: var(--bg-2);
  border-left-color: var(--text-200);
}
...
.result-answer :deep(.md-quote) {
  ...
  padding: 12px 16px;
  background: var(--bg-2);
  border-left: 3px solid var(--text-200);
  color: var(--text-300);
}
