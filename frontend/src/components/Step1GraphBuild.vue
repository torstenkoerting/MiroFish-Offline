    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success">{{ $t('step1.statusCompleted') }}</span>
            <span v-else-if="currentPhase === 0" class="badge processing">{{ $t('step1.statusGenerating') }}</span>
            <span v-else class="badge pending">{{ $t('step1.statusWaiting') }}</span>
          </div>
        </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success">{{ $t('step1.statusCompleted') }}</span>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ $t('step1.buildCompleteHint') }}</p>
          <button 
            class="action-btn" 
...
.badge.accent { background: var(--lime); color: var(--bg-0); }
