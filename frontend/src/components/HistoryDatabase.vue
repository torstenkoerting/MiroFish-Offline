...
.status-icon:nth-child(1).available { color: var(--pink); } /* Graph Construction - Blue */
.status-icon:nth-child(2).available { color: var(--status-yellow); } /* Environment Setup - Orange */
.status-icon:nth-child(3).available { color: var(--status-green); } /* Analysis Report - Green */
...
.card-progress.completed { color: var(--status-green); }    /* Completed - Green */
.card-progress.in-progress { color: var(--status-yellow); }  /* In Progress - Orange */
.card-progress.not-started { color: var(--text-400); }  /* Not Started - Gray */
.card-status.pending { color: var(--text-400); }
...
.file-tag.txt { background: var(--bg-3); color: #757575; }
...
.file-tag.other { background: var(--bg-3); color: var(--text-300); }
...
.project-card:hover .card-files-wrapper {
  ...
  background: linear-gradient(135deg, var(--bg-2) 0%, #f8f9fa 100%);
}
...
.card-footer .card-progress.completed { color: var(--status-green); }
.card-footer .card-progress.in-progress { color: var(--status-yellow); }
.card-footer .card-progress.not-started { color: var(--text-400); }
...
.modal-progress.completed { color: var(--status-green); background: rgba(16, 185, 129, 0.1); }
.modal-progress.in-progress { color: var(--status-yellow); background: rgba(245, 158, 11, 0.1); }
.modal-progress.not-started { color: var(--text-400); background: var(--bg-3); }
...
.modal-btn.btn-project .btn-icon { color: var(--pink); }
.modal-btn.btn-simulation .btn-icon { color: var(--status-yellow); }
.modal-btn.btn-report .btn-icon { color: var(--status-green); }
